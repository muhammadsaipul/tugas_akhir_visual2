...
if (ZQuery1.Locate('tanggal',Edit1.Text,[]))and (ZQuery1.Locate('semester',Edit2.Text,[])) then
begin
...
ZQuery1.SQL.Clear;
ZQuery1.SQL.Add('insert into tabel_semester values(null,"'+edit1.Text+'","'+edit2.Text+'","'+edit3.Text+'","'+edit4.Text+'")');
ZQuery1.ExecSQL ;
...
ZQuery1.SQL.Clear;
ZQuery1.SQL.Add('select * from tabel_semester');
ZQuery1.Open;
...
if (Edit1.Text ='')or(Edit2.Text='')or(Edit3.Text='')then
  ...
  begin
  ZQuery1.SQL.Clear;
  ZQuery1.SQL.Add('Update tabel_semester set tanggal ="'+Edit1.Text+'",semester="'+Edit2.Text+'" where id_semester="'+id+'"');
  ZQuery1.ExecSQL;
  ZQuery1.SQL.Clear;
  ZQuery1.SQL.Add('select * from tabel_semester');
  ZQuery1.Open;
...
begin
id:=DBGrid1.DataSource.DataSet.FieldByName('id_semester').AsString;
ZQuery1.SQL.Clear;
ZQuery1.SQL.Add(' delete from tabel_semester where tanggal="'+id+'"');
ZQuery1. ExecSQL;
ZQuery1.SQL.Clear;
ZQuery1.SQL.Add('select * from tabel_semester');
ZQuery1.Open;
